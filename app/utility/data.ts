    ...
    faqsArray: [
        {
            ...
            ans: 'Staffton helps hospitals and healthcare organizations hire qualified medical professionals faster, including doctors, nurses, specialists, technicians, and support staff, through a streamlined hiring platform.'
        },
        {
            question: 'How does Staffton improve the hiring process?',
            ans: 'Staffton improves hiring by helping employers quickly find, screen, and shortlist the right medical professionals based on role, experience, skills, certifications, and availability.'
        },
        {
            question: 'What features does Staffton offer for employers?',
            ans: 'Staffton offers job posting, candidate matching, resume screening, applicant tracking, interview scheduling, credential verification support, and hiring insights for healthcare employers.'
        },
        {
...
export const forHospitalsFeatureGridSection = {
...
export const forProfessionalsFeatureGridSection = {
